 ...
 */
final class Version20220821080822 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE notes (id INT AUTO_INCREMENT NOT NULL, module_id INT DEFAULT NULL, apprenant_id INT DEFAULT NULL, intervenant_id INT DEFAULT NULL, note VARCHAR(255) DEFAULT NULL, coefmodule VARCHAR(255) DEFAULT NULL, coefbloc VARCHAR(255) DEFAULT NULL, moy VARCHAR(255) DEFAULT NULL, moygeneral VARCHAR(255) DEFAULT NULL, UNIQUE INDEX UNIQ_11BA68CAFC2B591 (module_id), UNIQUE INDEX UNIQ_11BA68CC5697D6D (apprenant_id), UNIQUE INDEX UNIQ_11BA68CAB9A1716 (intervenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE notes ADD CONSTRAINT FK_11BA68CAB9A1716 FOREIGN KEY (intervenant_id) REFERENCES intervenants (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE notes DROP FOREIGN KEY FK_11BA68CAB9A1716');
