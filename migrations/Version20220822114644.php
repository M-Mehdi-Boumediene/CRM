 ...
 */
final class Version20220822114644 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE cv (id INT AUTO_INCREMENT NOT NULL, etudiant_id INT DEFAULT NULL, intervenant_id INT DEFAULT NULL, type VARCHAR(255) DEFAULT NULL, debut DATE DEFAULT NULL, fin DATE DEFAULT NULL, titre VARCHAR(255) DEFAULT NULL, description LONGTEXT DEFAULT NULL, entreprise VARCHAR(255) DEFAULT NULL, ecole VARCHAR(255) DEFAULT NULL, formation VARCHAR(255) DEFAULT NULL, INDEX IDX_B66FFE92DDEAB1A3 (etudiant_id), INDEX IDX_B66FFE92AB9A1716 (intervenant_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE cv ADD CONSTRAINT FK_B66FFE92DDEAB1A3 FOREIGN KEY (etudiant_id) REFERENCES etudiants (id)');
        $this->addSql('ALTER TABLE cv ADD CONSTRAINT FK_B66FFE92AB9A1716 FOREIGN KEY (intervenant_id) REFERENCES intervenants (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE cv DROP FOREIGN KEY FK_B66FFE92AB9A1716');
